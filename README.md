...
- I made [🚀 FoodDukan App 😍](https://foodfire-app.netlify.app/) from scratch using React.js and Parcel.js, which is the part of this course.
...
- 📟📝 _Digital and Handwritten Notes_
  - 📟 [_Digital Notes of Live Class_](https://bit.ly/Namaste-React-Digital-Chapter01) `Credit` - [Arpan Kesh](https://www.linkedin.com/in/suraj-kumar-6a85aa1a9/)
...
```bash
  git clone "https://github.com/nerdsuraj/namaste_react"
```
