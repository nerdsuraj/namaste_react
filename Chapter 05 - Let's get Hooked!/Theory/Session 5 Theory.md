...
# whenever the state varible update page will re-render
```
reconcilation alogoritham { React fiber }

virtual dom is represnation of actual dom

virtual dom is just the normal js object
```